...
public class SecureDlmsServiceThread extends Thread {
    private static final String TAG = SecureDlmsServiceThread.class.getSimpleName();
    ...
    public SecureDlmsServiceThread(Socket s, EnergyMeter device) {
        this.device = device;
        myClientSocket = s;
        device.setMakeString(Constants.SECURE_DLMS_STR);
    ...
    public void run() {
        ...
        try {
            ...
            // 3rd
            cmd = commandsGenerator.send_Athentication();
            write(cmd);
