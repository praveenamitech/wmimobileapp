...
public class LNTServiceThread extends Thread {
    private static final String TAG = LNTServiceThread.class.getSimpleName();
    ...
    public LNTServiceThread(Socket s, EnergyMeter device) {
        this.device = device;
        myClientSocket = s;
        device.setMakeString(Constants.LNT_STR);
